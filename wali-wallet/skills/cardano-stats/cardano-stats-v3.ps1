# Cardano Stats Bot Script - V3 with direct Discord posting
...
try {
    ...
    # Save message to file for the agent to post
    $tempFile = Join-Path $PSScriptRoot "last-message.txt"
    $message | Set-Content -Path $tempFile -NoNewline -Encoding UTF8
    
    Write-Host "Saved to file for agent posting" -ForegroundColor Green
